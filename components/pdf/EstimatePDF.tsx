...
// Use a regular function export, not arrow function
export default function EstimatePDF({ estimate, client, items }: any) {
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View>
            ...
            <Text style={styles.documentNumber}>#{estimate?.estimate_number || estimate?.id?.slice(0, 8)}</Text>
            <Text style={styles.documentNumber}>Date: {new Date(estimate?.created_at).toLocaleDateString()}</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text>Thank you for choosing One Square Roof LLC</Text>
        </View>
      </Page>
    </Document>
  );
