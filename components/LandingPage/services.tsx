  ...
  return (
    <section className="w-full bg-white py-20">
      ...
      <div className="mx-auto mb-14 max-w-6xl px-6 text-center">
        ...
        <button className="mt-8 rounded-full bg-orange-500 px-8 py-3 text-sm font-semibold text-white transition hover:bg-orange-600">
          Contact Us
        </button>
      </div>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 md:grid-cols-2 lg:grid-cols-3">
        {services.map((service, index) => (
          ...
          >
            {/* Image */}
            <div
              className="h-80 w-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
