...
>
  <span className="inline-block  rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-4 py-1 text-white shadow-lg md:px-5 md:py-2 md:text-7xl text-5xl">
    OSR
  </span>{" "}
...
<h1
  className="text-7xl lg:text-8xl font-semibold leading-none tracking-tight transition"
  style={{
    transform: `translateY(${textOffset}px)`,
    opacity,
  }}
