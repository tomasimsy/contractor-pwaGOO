  ...
  // const [client, setClient] = useState<Client | null>(null);
    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-[#f6f7f9] pb-24">
        ...
        {/* HEADER */}
        <Header title="Estimates" backLink="/" rightAction={ <button onClick={()=> router.push("/estimates/create")}
          className="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 bg-white text-lg
          ...
          <div className="mx-auto max-w-4xl p-4">
            ...
            {loading && (
            <div
              className="rounded-2xl border border-gray-200 bg-white py-10 text-center text-sm text-gray-500 shadow-sm">
              Loading estimates...
            </div>
            )}
            ...
            <div className="space-y-3">
              ...
              <div key={estimate.id}
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  {/* LEFT */}
                  <div className="min-w-0 flex-1 cursor-pointer" onClick={()=> router.push(`/estimates/${estimate.id}`)}
                    >
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      ...
                      {(estimate as any).opened_device && <span className="ml-1 text-gray-400">• {(estimate as
                        any).opened_device}</span>}
                      {(estimate as any).opened_ip && <span className="ml-1 text-gray-400">• IP: {(estimate as
                        any).opened_ip}</span>}
                      {(estimate as any).opened_count > 1 && <span className="ml-1 text-gray-400">• {(estimate as
                        any).opened_count} views</span>}
                    </div>
                    )}
                  </div>
                  ...
                  <div className="flex shrink-0 flex-col items-end">
                    ...
                    <button onClick={()=>
                      ...
                      className="mt-3 flex items-center gap-1 rounded-lg px-2 py-1 text-[11px] text-gray-400 transition
          ...
          {/* DELETE MODAL */}
          <DeleteModal isOpen={deleteModal.isOpen} onClose={()=>
            setDeleteModal({
            isOpen: false,
            id: "",
            name: "",
